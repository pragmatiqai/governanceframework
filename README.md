...
| [Agentic_AI_Governance_Executive_Overview.md](Agentic_AI_Governance_Executive_Overview.md) | The executive overview: the framework in condensed form for the CISO, the IT Director and other stakeholders. Part I, the lifecycle in practice (what is required to deploy a new AI system or agent, and when it changes); Part II, the governance model; reading paths by role |
| [Agentic_AI_Governance_Executive_Overview.html](Agentic_AI_Governance_Executive_Overview.html) | The same executive overview as one web page, with a contents sidebar |
| [diagrams/overview/](diagrams/overview/) | The executive overview's sixteen figures |
...
Each figure of the framework is also provided as a PNG, for slides and documents.

The executive overview comes in two forms with the same text: Markdown, to read here on GitHub, and one
self-contained web page with its figures inside, to download and open in a browser or print to PDF.
